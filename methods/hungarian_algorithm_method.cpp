...
/* Документация к функции находится в methods/methods.hpp. Здесь функция
 * выбирает тип элементов матрицы стоимостей по полю "weight_type" и
 * запускает соответствующую специализацию вспомогательной функции. */
